...
lazy val core = project
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      "dev.zio"       %% "zio"          % "1.0.0-RC21+12-168d1c26-SNAPSHOT",
      "dev.zio"       %% "zio-test"     % "1.0.0-RC21+12-168d1c26-SNAPSHOT" % "test",
      "dev.zio"       %% "zio-test-sbt" % "1.0.0-RC21+12-168d1c26-SNAPSHOT" % "test"
    ),
